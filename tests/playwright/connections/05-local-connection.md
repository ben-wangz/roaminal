...
1. In Settings > Connection definitions, click `Start local connection` once. Correlate one POST to
...
5. Return to Settings with the rail control and back to the workspace. Both
   processes and output remain available; opening Settings does not terminate
   a connection.
